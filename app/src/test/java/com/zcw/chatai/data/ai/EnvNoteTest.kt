...
class EnvNoteTest {
    ...
    fun formatsDateWeekdayAndTime() {
        assertEquals("当前时间：2026年9月20日 星期日 14:32:05", EnvNote.format(nowMs, shanghai))
    }
    ...
    fun convertsToGivenZone() {
        ...
        assertEquals("当前时间：2026年9月20日 星期日 06:32:05", EnvNote.format(nowMs, utc))
    }
    ...
    fun sameInstantFallsOnDifferentDateAcrossZones() {
        ...
        assertEquals("当前时间：2026年9月20日 星期日 02:32:05", EnvNote.format(nowMs, newYork))
    }

    @Test
    fun mondayMapsCorrectly() {
        // 2026-09-21 00:00:00 +08:00（星期一）。
        assertEquals("当前时间：2026年9月21日 星期一 00:00:00", EnvNote.format(1_789_920_000_000L, shanghai))
    }
}
